#ifndef GREATER_THAN_MIR_VALUE_H
#define GREATER_THAN_MIR_VALUE_H

#include "mir-values/mir_value.h"
#include "mir-values/mir_value_converter.h"

class greater_than_mir_value : public mir_value {
public:
    greater_than_mir_value() : mir_value(
        std::regex (R"(^Gt\((.+), (.+)\)$)"),
...
#endif //GREATER_THAN_MIR_VALUE_H
