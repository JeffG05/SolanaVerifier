#ifndef CHECKED_ADD_MIR_VALUE_H
#define CHECKED_ADD_MIR_VALUE_H
...
class checked_add_mir_value : public mir_value {
public:
    checked_add_mir_value() : mir_value(
        std::regex (R"(^CheckedAdd\((.+), (.+)\)$)"),
