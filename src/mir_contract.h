...
private:
    ...
    void generate_block_assignment(std::ostream* out, const std::string &variable, const std::string &value, bool returns, const mir_statements& all_variables, int indents=1, bool prevent_modify=false);
